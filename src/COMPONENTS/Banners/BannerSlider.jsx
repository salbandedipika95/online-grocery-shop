...
const BannerSlider = () => {
  const data = [
    ...
    },
    {
      ...
      title: "Fresh Vegetables & Fruits at your doorstep",
      description:
        "Cherries and berries. Sweet peaches and nectarines. Summer baking season is here, and I could not be more delighted.",
      buttons: "https://www.google.com",
    },
  ];
          ...
          return (
            <div className="imagecont" key={item.id}>
              ...
              <div className="content">
                ...
                <button onClick={item.buttons}>Shop More</button>
              </div>
            </div>
          );
        })}
